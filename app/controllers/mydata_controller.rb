class MydataController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mydatum.save
        format.html { redirect_to @mydatum, notice: 'Mydatum was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mydatum.update(mydatum_params)
        format.html { redirect_to @mydatum, notice: 'Mydatum was successfully updated.' }
  ...
  def destroy
    @mydatum.destroy
    respond_to do |format|
      format.html { redirect_to mydata_url, notice: 'Mydatum was successfully destroyed.' }
  ...
  private
    ...
    def mydatum_params
      params.require(:mydatum).permit(:student_name, :user)
    end
end
